...
import { BusinessPaymentDialogComponent } from '../../../viewdetailedbroadband/businessplan/business-payment-dialog/business-payment-dialog.component';
import { HandelBusinessAuthenticationDialogeComponent } from '../../../viewdetailedbroadband/businessplan/handel-business-authentication-dialoge/handel-business-authentication-dialoge.component';
...
@Component({
  selector: 'app-english-entertainment',
  templateUrl: './english-entertainment.component.html',
  styleUrl: './english-entertainment.component.scss'
})
export class EnglishEntertainmentComponent implements AfterViewInit{
