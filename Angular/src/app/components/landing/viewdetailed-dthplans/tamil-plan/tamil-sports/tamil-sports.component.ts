...
@Component({
  selector: 'app-tamil-sports',
  templateUrl: './tamil-sports.component.html',
  styleUrl: './tamil-sports.component.scss'
})
export class TamilSportsComponent implements AfterViewInit{
  ...
  ngAfterViewInit() {
    this.adminService.getTamilSportChannels().subscribe((channelsData : Channel[]) => {
