...
@Component({
  selector: 'app-hindi-sport',
  templateUrl: './hindi-sport.component.html',
  styleUrl: './hindi-sport.component.scss'
})
export class HindiSportComponent implements AfterViewInit{
