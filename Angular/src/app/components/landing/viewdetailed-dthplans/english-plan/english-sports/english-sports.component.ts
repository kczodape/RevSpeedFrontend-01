...
@Component({
  selector: 'app-english-sports',
  templateUrl: './english-sports.component.html',
  styleUrl: './english-sports.component.scss'
})
export class EnglishSportsComponent implements AfterViewInit{
